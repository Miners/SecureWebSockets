...
public class WebSocketOptions {
     ...
     */
    public WebSocketOptions(final WebSocketOptions other) {
     ...
     */
    public void setReceiveTextMessagesRaw(final boolean enabled) {
     ...
     */
    public void setMaxFramePayloadSize(final int size) {
        if (size > 0) {
     ...
     */
    public void setMaxMessagePayloadSize(final int size) {
        if (size > 0) {
     ...
     */
    public void setTcpNoDelay(final boolean enabled) {
        mTcpNoDelay = enabled;
    }
     ...
     */
    public void setSocketReceiveTimeout(final int timeoutMs) {
        if (timeoutMs >= 0) {
     ...
     */
    public void setSocketConnectTimeout(final int timeoutMs) {
        if (timeoutMs >= 0) {
     ...
     */
    public void setValidateIncomingUtf8(final boolean enabled) {
     ...
     */
    public void setMaskClientFrames(final boolean enabled) {
    ...
    /**
     * If True, we will use a socket factory for wss connections
     *  that doesn't care about authenticating certificates
     *  
     * DEFAULT: false
     *  
     * @param useInsecure
     */
    public void setUseInsecureSocketFactory(final boolean useInsecure) {
        mUseInsecureSocketFactory = useInsecure;
    }
